# svelte/kit + typescript + tailwind

A baked version of [https://github.com/babichjacob/svelte-add-tailwindcss](https://github.com/babichjacob/svelte-add-tailwindcss).
